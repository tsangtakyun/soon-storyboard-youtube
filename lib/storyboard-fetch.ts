...
export async function fetchStoryboardByScriptId(
  ...
  return {
    ...
    subjectReference: storyboard.subject_reference ?? undefined,
...
export async function ensureStoryboardForScript(
  ...
  return {
    ...
    subjectReference: row.subject_reference ?? undefined,
    status: row.status,
    shots: [],
...
export function mapShotRow(row: any): StoryboardShot {
  return {
    ...
    scriptExcerpt: row.script_excerpt ?? undefined,
    visualInstruction: row.visual_instruction ?? undefined,
